...
$TMP               = strlen($Acao) < 2 ? '0'.($Acao++) : ($Acao++);
$P[$Grupo][$TMP]   = Array('Acao' => $Grupo.$TMP, 'Nome' => 'Busca de CEP (cadastro) para '.$Modulo, 'Chave' => 'GET|'.$pCT.'|Novo|CEP', 'Modulo' => $Modulos, 'Regra' => 1, 'Nivel' => 2, 'Usuario' => '', 'ID' => '', 'Especial' => '');
$TMP               = strlen($Acao) < 2 ? '0'.($Acao++) : ($Acao++);
...
$TMP               = strlen($Acao) < 2 ? '0'.($Acao++) : ($Acao++);
$P[$Grupo][$TMP]   = Array('Acao' => $Grupo.$TMP, 'Nome' => 'Busca de CEP (edição) para '.$Modulo, 'Chave' => 'GET|'.$pCT.'|Editar|CEP', 'Modulo' => $Modulos, 'Regra' => 1, 'Nivel' => 3, 'Usuario' => '', 'ID' => '', 'Especial' => '');
$TMP               = strlen($Acao) < 2 ? '0'.($Acao++) : ($Acao++);
