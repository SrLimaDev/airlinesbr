...
// Variaveis
$Cadastro          = defined('EMPRESA_Confirmar_Edicao') ? (int)EMPRESA_Confirmar_Edicao : 0;
$Tipo              = isSet($_POST['Tipo']) ? $_POST['Tipo'] : ( defined('EMPRESA_Tipo') ? EMPRESA_Tipo : 'Pessoa Física' );
...
$Estado            = isSet($CEP['Estado']) ? $CEP['Estado'] : ( isSet($_POST['End_Estado']) ? $_POST['End_Estado'] : ( defined('EMPRESA_Estado') ? EMPRESA_Estado : LOCAL_UF ) );
$Regiao            = isSet($CEP['Regiao']) ? $CEP['Regiao'] : ( isSet($_POST['End_Regiao']) ? $_POST['End_Regiao'] : ( defined('EMPRESA_Regiao') ? EMPRESA_Regiao : LOCAL_Regiao ) );
$Usar_ID           = defined('EMPRESA_ID') ? EMPRESA_ID : False;
$Acesso            = isSet($_POST['Acesso']) ? $_POST['Acesso'] : 0;
// Options
$Tipo_OPT          = OPT_Comum('Empresa_Tipo', True, $Tipo, 0, '', False);
...
Else {
?>
                  <div class="Form_Linha"><div class="Form_Esq"><b>Razão Social:</b></div><div class="Form_Dir"><input class="Form_Text" type="text" name="Razao_Social" id="Razão Social" value="<?php Echo isSet($_POST['Razao_Social']) ? $_POST['Razao_Social'] : ''; ?>" maxlength="100" style="width:98%;"></div></div>
                  <div class="Form_Linha"><div class="Form_Esq">Nome Fantasia:</div><div class="Form_Dir"><input class="Form_Text" type="text" name="Nome_Fantasia" id="Nome Fantasia" value="<?php Echo isSet($_POST['Nome_Fantasia']) ? $_POST['Nome_Fantasia'] : ''; ?>" maxlength="50" style="width:350px;"></div></div>
                  <div class="Form_Linha"><div class="Form_Esq"><b>CNPJ:</b></div><div class="Form_Dir"><input class="Form_Text" type="text" name="CNPJ" id="" value="<?php Echo isSet($_POST['CNPJ']) ? $_POST['CNPJ'] : ''; ?>" maxlength="14" style="width:100px;"></div></div>
                  <div class="Form_Linha"><div class="Form_Esq">IE:</div><div class="Form_Dir"><input class="Form_Text" type="text" name="IE" id="" value="<?php Echo isSet($_POST['IE']) ? $_POST['IE'] : ''; ?>" maxlength="20" style="width:140px;"></div></div>
                  <div class="Form_Linha"><div class="Form_Esq">Fundação:</div><div class="Form_Dir"><input class="Form_Text" type="text" name="Nascimento" id="Fundação" value="<?php Echo isSet($_POST['Nascimento']) ? $_POST['Nascimento'] : ''; ?>" maxlength="10" style="width:70px; text-align:center;" onKeyUp="this.value = Mascara_Data(this);"></div></div>
                <div class="Form_Linha"><div class="Form_Titulo">Responsável</div></div><div class="Form_Sep"></div>
                  <div class="Form_Linha"><div class="Form_Esq">Nome:</div><div class="Form_Dir"><input class="Form_Text" type="text" name="Nome" id="Responsável" value="<?php Echo isSet($_POST['Nome']) ? $_POST['Nome'] : ''; ?>" maxlength="50" style="width:350px;"></div></div>
                  <div class="Form_Linha"><div class="Form_Esq">CPF:</div><div class="Form_Dir"><input class="Form_Text" type="text" name="CPF" id="CPF do Responsável" value="<?php Echo isSet($_POST['CPF']) ? $_POST['CPF'] : ''; ?>" maxlength="11" style="width:80px;"></div></div>
                  <div class="Form_Linha"><div class="Form_Esq">RG:</div><div class="Form_Dir"><input class="Form_Text" type="text" name="RG" id="RG do Responsável" value="<?php Echo isSet($_POST['RG']) ? $_POST['RG'] : ''; ?>" maxlength="20" style="width:140px;"></div></div>
<?php
     }
?>
                <div class="Form_Linha"><div class="Form_Titulo">Contatos</div></div><div class="Form_Sep"></div>
                  ...
                  <div class="Form_Linha"><div class="Form_Esq"><b>Telefone:</b></div><div class="Form_Dir"><input class="Form_Text" type="text" name="Tel_DDD" id="Telefone (DDD)" value="<?php Echo isSet($_POST['Tel_DDD']) ? $_POST['Tel_DDD'] : ( defined('EMPRESA_DDD') ? EMPRESA_DDD : '' ); ?>" maxlength="2" style="width:20px; text-align:center;"> <input class="Form_Text" type="text" name="Tel" id="Telefone" value="<?php Echo isSet($_POST['Tel']) ? $_POST['Tel'] : ''; ?>" maxlength="9" style="width:70px; text-align:center;"> <select class="Form_Select_Inline" name="Tel_Tipo" id="Telefone (Tipo)"><?php Echo $Tel_Tipo_OPT; ?></select></div></div>
                  <div class="Form_Linha"><div class="Form_Esq">Telefone Secundário:</div><div class="Form_Dir"><input class="Form_Text" type="text" name="Tel2_DDD" id="Telefone Secundário (DDD)" value="<?php Echo isSet($_POST['Tel2_DDD']) ? $_POST['Tel2_DDD'] : ( defined('EMPRESA_DDD') ? EMPRESA_DDD : '' ); ?>" maxlength="2" style="width:20px; text-align:center;"> <input class="Form_Text" type="text" name="Tel2" id="Telefone Secundário" value="<?php Echo isSet($_POST['Tel2']) ? $_POST['Tel2'] : ''; ?>" maxlength="9" style="width:70px; text-align:center;"> <select class="Form_Select_Inline" name="Tel2_Tipo" id="Telefone Secundário (Tipo)"><?php Echo $Tel2_Tipo_OPT; ?></select></div></div>
                  <!--<div class="Form_Linha"><div class="Form_Esq">Telefone Terciário:</div><div class="Form_Dir"><input class="Form_Text" type="text" name="Tel3_DDD" id="Telefone Terciário (DDD)" value="<?php Echo isSet($_POST['Tel3_DDD']) ? $_POST['Tel3_DDD'] : ( defined('EMPRESA_DDD') ? EMPRESA_DDD : '' ); ?>" maxlength="2" style="width:20px; text-align:center;"> <input class="Form_Text" type="text" name="Tel3" id="Telefone Terciário" value="<?php Echo isSet($_POST['Tel3']) ? $_POST['Tel3'] : ''; ?>" maxlength="9" style="width:70px; text-align:center;"> <select class="Form_Select_Inline" name="Tel3_Tipo" id="Telefone Terciário (Tipo)"><?php Echo $Tel3_Tipo_OPT; ?></select></div></div>-->
