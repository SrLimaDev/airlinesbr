   ...
   { Switch($Acao)
     {
       ...
       Case 'Multipla-Ativar':
            ...
            If ($_SERVER['REQUEST_METHOD'] == 'POST' && isSet($_POST['Selecao']) && !empty($_POST['Selecao']))
               { $Acao       = Empresa_Acoes($_POST['Selecao'], substr($Acao, strpos($Acao, '-') + 1));
       ...
       Case 'Multipla-Excluir':
            ...
            If ($_SERVER['REQUEST_METHOD'] == 'GET' && isSet($_SESSION['Selecao']) && isSet($_GET['pOK']))
               { $Acao       = Empresa_Acoes($_SESSION['Selecao'], substr($Acao, strpos($Acao, '-') + 1));
...
$_Filtros->Adicionar($i++, 'Tipo', 'Tipo', 'Texto', OPT_Comum('Empresa_Tipo', False));
