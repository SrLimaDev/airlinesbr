...
// Cores
define('TEMA_COR_01', 'DDFFDD'); #$|Texto|9|Texto|0|0|0# Cor 01 do tema\n- Não use # (jogo da velha) no valor e sempre informe o código web (não use os nomes, ex: black, red, green...) da cor
define('TEMA_COR_02', 'A4FFA4'); #$|Texto|9|Texto|0|0|0# Cor 02 do tema\n- Não use # (jogo da velha) no valor e sempre informe o código web (não use os nomes, ex: black, red, green...) da cor
define('TEMA_COR_03', '00E600'); #$|Texto|9|Texto|0|0|0# Cor 03 do tema\n- Não use # (jogo da velha) no valor e sempre informe o código web (não use os nomes, ex: black, red, green...) da cor
define('TEMA_COR_04', '00A800'); #$|Texto|9|Texto|0|0|0# Cor 04 do tema\n- Não use # (jogo da velha) no valor e sempre informe o código web (não use os nomes, ex: black, red, green...) da cor
define('TEMA_COR_05', '00A800'); #$|Texto|9|Texto|0|0|0# Cor 05 do tema\n- Não use # (jogo da velha) no valor e sempre informe o código web (não use os nomes, ex: black, red, green...) da cor
define('TEMA_COR_Destaque', '00A800'); #%|Texto|9|Texto|0|0|0# Cor de destaque do tema\n- Não use # (jogo da velha) no valor e sempre informe o código web (não use os nomes, ex: black, red, green...) da cor
