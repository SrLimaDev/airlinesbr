...
// Cores
define('TEMA_COR_01', 'FFFBEA'); #$|Texto|9|Texto|0|0|0# Cor 01 do tema\n- Não use # (jogo da velha) no valor e sempre informe o código web (não use os nomes, ex: black, red, green...) da cor
define('TEMA_COR_02', 'FFF4CA'); #$|Texto|9|Texto|0|0|0# Cor 02 do tema\n- Não use # (jogo da velha) no valor e sempre informe o código web (não use os nomes, ex: black, red, green...) da cor
define('TEMA_COR_03', 'FFE16A'); #$|Texto|9|Texto|0|0|0# Cor 03 do tema\n- Não use # (jogo da velha) no valor e sempre informe o código web (não use os nomes, ex: black, red, green...) da cor
define('TEMA_COR_04', 'FFCC00'); #$|Texto|9|Texto|0|0|0# Cor 04 do tema\n- Não use # (jogo da velha) no valor e sempre informe o código web (não use os nomes, ex: black, red, green...) da cor
define('TEMA_COR_05', 'FFCC00'); #$|Texto|9|Texto|0|0|0# Cor 05 do tema\n- Não use # (jogo da velha) no valor e sempre informe o código web (não use os nomes, ex: black, red, green...) da cor
define('TEMA_COR_Destaque', 'FF6600'); #%|Texto|9|Texto|0|0|0# Cor de destaque do tema\n- Não use # (jogo da velha) no valor e sempre informe o código web (não use os nomes, ex: black, red, green...) da cor
